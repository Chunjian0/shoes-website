            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{ route('inventory.checks.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            <label for="check_date" class="block text-sm font-medium text-gray-700">Check out dates</label>
                            <input type="date" name="check_date" id="check_date" value="{{ old('check_date', date('Y-m-d')) }}" required
                        ...
                        <div class="mb-4">
                            <h3 class="text-lg font-medium text-gray-900">Inventory of products</h3>
                        ...
                        <div class="flex justify-end mt-6">
                            <a href="{{ route('inventory.checks.index') }}" class="bg-white py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                Cancel
                            </a>
