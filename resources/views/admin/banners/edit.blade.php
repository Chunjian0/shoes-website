                ...
                <form action="{{ route('admin.banners.update', $banner) }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div class="mb-4">
                                <input type="hidden" name="media_id" id="media_id" value="{{ old('media_id', $banner->media_id) }}">
                                
                                <div x-data="{ 
                                    selectedImage: '{{ $banner->getImageUrl() }}',
                                    uploading: false,
                                    ...
                                    async uploadFile(file) {
                                        ...
                                        formData.append('model_id', '{{ $banner->id }}');
                                    ...
                                    <button type="button" 
                                        ...
                                        :disabled="uploading">
                                        <span x-text="uploading ? 'Uploading...' : 'Change Image'"></span>
                                    </button>
                                </div>
