    ...
    <ol class="inline-flex items-center space-x-1 md:space-x-3">
        ...
        <li>
            <div class="flex items-center">
                ...
                <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2">Out of stock</span>
            </div>
        </li>
    </ol>
</nav>
...
<div class="bg-white rounded-lg shadow-sm">
    <div class="p-6">
        ...
        <div class="mb-6 flex justify-between items-center">
            <h2 class="text-xl font-semibold text-gray-800">Out of stock</h2>
            <div class="flex space-x-2">
                <a href="{{ route('stock.out-of-stock.export') }}" class="bg-yellow-500 hover:bg-yellow-600 text-white px-4 py-2 rounded-lg">
                    Export list
                </a>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                            Recent inventory time
                        </th>
                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                            Recent outbound time
                        </th>
                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                            operate
                        </th>
